void updateLED() 
{
  ...
  if (LEDStatus == "failsafe") 
  {
    if (rc_status == false) 
    {
      ...
      top_strip.clear();
      bottom_strip.clear();
      top_strip.setPixelColor(animIndex, top_strip.Color(100, 60, 0));
      bottom_strip.setPixelColor(animIndex, bottom_strip.Color(100, 60, 0));
    }
    else
    {
  ...
  else if (LEDStatus == "armed")
  {
    ...
    bottom_strip.fill(bottom_strip.Color(100, 0, 0), round(8 - (abs(volts - 12.4) * 5)), 8);
    }
  }
